...
public class AppChecker {
    ...
    public interface Listener {
        void onForeground(String process) throws PackageManager.NameNotFoundException;
    }
    ...
    public AppChecker() {
        ...
        handler = new Handler(Looper.getMainLooper());
            detector = new BackgroundAppDetector();
    }
    ...
    private void getForegroundAppAndNotify(Context context) throws PackageManager.NameNotFoundException {
    ...
    public String getForegroundApp(Context context) throws PackageManager.NameNotFoundException {
