package com.example.rishivijaygajelli.appconengine.rootutil;

import android.content.Context;
import android.util.Log;

import com.example.rishivijaygajelli.appconengine.BuildConfig;
...
public class RootUtil extends ContainerApp {
